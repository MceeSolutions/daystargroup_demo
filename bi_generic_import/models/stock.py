                ...
                if i != 0:
                    ...
                    try:
                        ...
                        raise exceptions.Warning(
                            _("Dont Use Charecter only use numbers")
                        )
                    ...
                    if self.lot_option == True:
                        ...
                        if bool(val):
                            ...
                            raise Warning(
                                _('Product Not Found  "%s"') % values.get("code")
                            )
                    else:
                        if prod_lst:
                            val["product"] = prod_lst[0].id
                ...
                if row_no <= 0:
                    ...
                    if self.lot_option == True:
                        if line:
                            ...
                            if bool(val):
                                product_uom_id = product_obj.browse(
                                    val["product"]
                                ).uom_id
                                lot_id = stock_lot_obj.search(
                                    [
                    ...
                    vals.update(
                        {
                            "line_ids": [
                                (0, 0, line_values)
                                for line_values in inventory.line_ids
                            ]
                        }
                    )
